% rep06: 第06回 演習課題レポート
% 2019年6月2日         by 学籍番号：29114116 名前：増田大輝
%
...
findallterms(Term) :-
  see('/home/29114/clf14116/rep06.txt'),       %パス指定したテキストファイルからの読み込みを受け付ける
...
%ファイルから入力を行い,Termとマッチする項を端末に表示する関数findallterms
findallterms(Term) :-
  see('/home/29114/clf14116/rep06.txt'),     %テキストファイルの読み込み
...
/*
(入力ファイル'/home/29114/clf14116/rep06.txt'の内容)
ok.
a.
like.
play.
...
%演習6.3(教科書p.155)
%端末から入力された英文について,単語間の空白を1つに調整した上で,カンマの前の単語との間には空白なし,後の単語との間には空白を一つ開けることで自然な英文への整形を行う処理を行うプログラム.


%端末から入力された英文について,単語間の空白を1つに調整した上で,カンマの前の単語との間には空白なし,後の単語との間には空白を一つ開けることで自然な英文への整形を行う処理を行う手続きsqueeze.
squeeze :-
  get0(C),                       %次の文字Cを読み込む
